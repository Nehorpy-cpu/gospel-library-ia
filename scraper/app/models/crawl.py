...
class Source(Base):
    ...
    crawl_strategy: Mapped[str] = mapped_column(String(80), default="html_discovery")
    rate_limit: Mapped[int] = mapped_column(Integer, default=30)
    max_pages_per_run: Mapped[int] = mapped_column(Integer, default=25)
    last_crawled_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    robots_policy_notes: Mapped[str | None] = mapped_column(Text)
